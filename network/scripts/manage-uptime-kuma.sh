...
# Uptime Kuma Service Management Script
# Usage: ./manage-uptime-kuma.sh [deploy|update|restart|status|logs|stop|start]
...
deploy() {
    ...
    ssh ${SERVER_USER}@${SERVER_HOST} "sudo mkdir -p ${REMOTE_PATH}/data"
